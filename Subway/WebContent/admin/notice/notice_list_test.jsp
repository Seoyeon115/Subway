...
<body>
	...
	<div id="ncontent">
		...
		<div class="board_list_wrapper">
					...
					<div class="cont_right">
						<div class="form_search">
								<form id="searchForm" method="get" name="searchForm">
									...
									<input name="subject" placeholder="검색어를 입력하세요" type="text" value="">
			...
			<!-- board 페이지 -->
			<div>
				<div class="pagination" id="ampaginationsm">
					...
					<a class="arr next" href="javascript:void(0);" onclick="paging.next(15);return false;"></a>-->
				</div> 
				<div>
					<a class="btn_right" href="notice_write.jsp"><button type="button" class="btn_write">글쓰기</button></a>
				</div>
			</div>
			<!--// board 페이지 -->
		</div>
