...
<%
	...
	ArrayList<MenuVO> list = dao.getCookieList();
%>
<!DOCTYPE html>
<html>
<head>
		...
		<section class="menu_list">
			...
			<div class="menu_sandwich">
				<ul>
					<% for(MenuVO vo : list){ %>
					<li>
						<a href="http://localhost:9000/Subway/order/order_cookie_detail.jsp?idx=<%=vo.getIdx()%>"><img src="http://localhost:9000/Subway/order/order_images/<%= vo.getImage_path()%>">
							<p>
