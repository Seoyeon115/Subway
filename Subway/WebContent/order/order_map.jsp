...
<body>
	...
	<div class="order_content">
		...
		<input type="text" id="fulladdress" name="fulladdress" style="width:1050px; margin-bottom:20px; color:rgb(0,145,50); font-weight:900; margin-left:120px; " disabled> 
		<form id="subwaymap_form" name="subwaymap_form" action="kakaoprocess.jsp" method="post"> 
		...
		<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6000b389c8694cf82d1840ce2e81f820&libraries=services"></script>
		<script>
