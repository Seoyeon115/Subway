...
<script type="text/javascript" src="/js/jquery/jquery_tmpl_min.js"></script>
					...
					<div class="content">
						...
						<div class="tab_wrapper">
							<ul id="tabList">
								...
								<li><a
									href="http://localhost:9000/Subway/event/event_list_ing.jsp">진행중인
										이벤트</a></li>
								<li><a
									href="http://localhost:9000/Subway/event/event_list_p.jsp">종료된
										이벤트</a></li>
							</ul>
						</div>
						<!--// tab -->
							...
							<ul id="eventListContent">
								...
								<li><a
									...
									onclick="view.view(191);return false;">
										<div class="event_img">
											<img
												src="../event/images/event_370x192_20210503055916911.jpg"
												alt="이달의 썹!프라이즈!">
										</div>
										<div class="event_info">
											<strong class="title">이달의 썹!프라이즈!</strong>
								...
								<li><a
									...
									onclick="view.view(186);return false;">
										<div class="event_img">
											<img
												src="../event/images/event_370x192_20201113042155863.jpg"
												alt="써브웨이 아침메뉴!">
										</div>
										<div class="event_info">
											<strong class="title">써브웨이 아침메뉴!</strong>
								...
								<li><a href="#" onclick="view.view(180);return false;">
										<div class="event_img">
											<img
												src="../event/images/event_370x192_20201006035853185.jpg"
								...
								<li class="close"><a href="#" onclick="return false;">
										<div class="event_img">
											<img
												src="../event/images/event_370x192_20210302025848613.jpg"
												alt="써브웨이 로스트 치킨 컬렉션">
										</div>
										<div class="event_info">
								...
								<li class="close"><a href="#" onclick="return false;">
										<div class="event_img">
											<img
												src="../event/images/event_370x192_20210226012255184.jpg"
												alt="이달의 썹!프라이즈!">
										</div>
										<div class="event_info">
											<strong class="title">이달의 썹!프라이즈!</strong>
				...
				slideBtnNext.addEventListener('click',
						function() {
							...
							pageDots[(curIndex === -1) ? slideLen - 1
									: curIndex].classList.remove('dot_active');
